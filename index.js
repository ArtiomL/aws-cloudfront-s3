...
exports.handler = async (event) => {
	return new Promise((resolve) => {
		...
		headers['Content-Security-Policy'] = [{	key: 'Content-Security-Policy',	value: "default-src 'self'; script-src 'self'; style-src 'self'; img-src 'self'; font-src 'self'; reflected-xss block;" }];
